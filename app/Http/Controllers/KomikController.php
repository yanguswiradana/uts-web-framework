...

{
...

    {
        ...
        $rawComics = [
            ...
            [
                ...
                'synopsis' => 'Dalam game gacha yang terkenal dengan kesulitannya yang mengerikan, Master peringkat ke-5 di dunia, Loki, kehilangan kesadaran saat menyerbu Dungeon. Apa Aku karakter game sekarang? Setelah bangun, Loki menyadari bahwa dia telah berubah menjadi Pahlawan Level 1 Bintang 1, Han Yslat. Untuk kembali ke Bumi, dia harus memimpin para master dan hero pemula dan membersihkan lantai 100 Dungeon. Kau macam-macam dengan orang yang salah! Ini adalah kisah perjuangan keras Master Loki yang belum pernah mengalami satu kekalahan pun.'
            ...
            [
                ...
                'synopsis' => 'Karena ancaman pengganggu sekolah untuk memberinya item game, Ha Dowan, shuttle game yang tidak beruntung, meninggal setelah bermain game sepanjang malam selama seminggu. Saat dia meninggal, dia dibangkitkan kembali ke ruang kelas satu minggu sebelum dia meninggal. Semuanya sama seperti hari itu. Satu-satunya hal yang berubah adalah jendela transparan mengambang di depannya. Apa? Gunakan keterampilan permainan yang saya mainkan sejauh ini untuk mengalahkan pengganggu?'
            ...
            [
                ...
                'synopsis' => 'Manusia tiba-tiba dipanggil untuk menjadi Walkers dan mereka perlu menyelesaikan menara untuk menyelamatkan dunia. Kemudian Regression Stone ditemukan, sekarang Walkers bisa kembali ke masa lalu. Dan perlahan-lahan semua orang pergi. "Jika aku pergi ke masa lalu, lalu bagaimana dengan nasib orang-orang di dunia ini? Siapa yang akan menyelamatkan mereka?" Harapan terakhir umat manusia, kelompok Carpe Diem, dibentuk oleh orang-orang yang menolak untuk meninggalkan dunia. Tapi begitu Walker terakhir mencapai lantai 100, dia tidak tahu lagi apa yang harus dia percayai. Ini adalah kisah tentang satu-satunya pria yang pantang mundur untuk meninggalkan dunianya meskipun semua walker yang lain kembali ke masa lalu.'
            ...
            [
                ...
                'synopsis' => 'Yuuji adalah seorang jenius di jalur dan lapangan. Tapi dia memiliki minat nol, dia senang sebagai anggota di Klub Penelitian Ilmu Ghaib. Meskipun dia di Klub hanya untuk iseng, hal-hal menjadi serius ketika semangat nyata muncul di sekolah. Hidup akan menjadi sangat aneh di SMA Sugisawa 3.'
            ...
            [
                ...
                'synopsis' => 'Nie Lie, Demon Spiritist yang terkuat di kehidupan masa lalunya, yang berdiri di puncak dunia persilatan, namun dia kehilangan nyawanya saat pertarungan dengan Sage Emperor dan keenam dewa berperingkat binatang. Jiwanya kemudian terlahir kembali saat dia masih berumur 13 tahun. Meskipun dia yang paling lemah di kelasnya dengan bakat terendah hanya di ranah Red soul, tapi dengan bantuan pengetahuan yang luas yang dia akumulasi dari kehidupan sebelumnya dia terlatih begitu cepat daripada siapa pun. Mencoba untuk melindungi kota di masa mendatang yang sedang diserang oleh binatang dan akhirnya hancur, serta melindungi kekasihnya, teman-temannya, dan keluarganya. Dan untuk menghancurkan keluarga Sacred yang meninggalkan tugas mereka dan mengkhianati kota dalam kehidupan masa lalunya.'
...

    {
        ...
        $latestUpdates = $allComics->reverse()->take(12);
...

    {
        ...
        switch ($sortBy) {
            ...
            case 'Terbanyak Dibaca':
                ...
                $filteredComics = $filteredComics->sortByDesc('rating');
        ...
        $allGenres = ['Action', 'Fantasy', 'Romance', 'Comedy', 'Horror', 'Slice of Life', 'Sci-Fi', 'Drama', 'Adventure', 'Cultivation', 'Gore', 'System', 'Magic', 'Murim', 'Supernatural', 'Thriller'];
