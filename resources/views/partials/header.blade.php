<header x-data="{ mobileMenuOpen: false }" class="bg-black shadow-2xl sticky top-0 z-50 border-b border-gray-800">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center space-x-4">
                ...
                {{-- Desktop Profile Button (LINKED TO LOGIN) --}}
    ...
    <div x-show="mobileMenuOpen"
        ...
        {{-- Mobile Profile Section (Dummy User) --}}
        <div class="pt-4 pb-4 border-t border-gray-800">
            <div class="flex items-center px-5">
                <div class="flex-shrink-0">
                    <div class="h-10 w-10 rounded-full bg-purple-600 flex items-center justify-center text-white font-bold">G</div>
                </div>
                <div class="ml-3">
